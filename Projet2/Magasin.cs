...
{
    public class Magasin:IEquatable<Magasin>
    {
        ...
        public void RemplirMagasin()
        {
            ...
            this.listProd.Ajoute(new ProduitARisque(4, "Produit n°4", 2.60, Categorie.NonConsommable, "Produit dangereux", "Inflammable", "Feu interdit"));
        }
